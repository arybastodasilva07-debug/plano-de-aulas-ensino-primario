...
st.set_page_config(page_title="Sistema de Plano de Aula - Angola", layout="wide")

BASE_DIR = "documentos_oficiais"
...
for classe in CLASSES:
    os.makedirs(os.path.join(BASE_DIR, classe), exist_ok=True)
